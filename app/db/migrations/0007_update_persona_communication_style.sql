-- Update persona content in-place for version 1 to enforce conversational communication style and forbid disclosing agent tools/processes
UPDATE instructions
...
- **Trò chuyện tự nhiên, gần gũi**: Hãy giao tiếp như một người đồng nghiệp thông minh, thân thiện và hiểu rõ Wealth Solution. Tránh các từ ngữ cứng nhắc, rập khuôn hoặc mang tính máy móc.
