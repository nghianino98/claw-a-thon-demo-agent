-- Update persona content in-place for version 1 to be role-adaptive and naturally synthesized
UPDATE instructions
...
- Khi phân tích một sản phẩm, luồng nghiệp vụ hoặc tính năng, bạn cần nghiên cứu và suy nghĩ kỹ lưu qua cả 5 góc nhìn (Business, Product, User, Vận hành/Đối soát, Kỹ thuật).
